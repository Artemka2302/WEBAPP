...
def show(course_id):
    ...
    # Запрос с пагинацией
    reviews_pagination = course.reviews.order_by(Review.created_at.desc()).paginate(
...
def reviews(course_id):
    ...
    # Получаем параметры сортировки и страницы
...
def add_review(course_id):
    ...
    # Обновляем рейтинг курса (только сумму и количество, rating сам пересчитается)
    course.rating_sum += rating
    course.rating_num += 1
    # Убираем строку: course.rating = course.rating_sum / course.rating_num
